...
namespace OrleansGrpcRepro
{
    ...
    {
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, MessageParser> _parsers = new();
        ...
        public bool IsSupportedType(Type itemType)
        {
            ...
            {
                if (!_parsers.ContainsKey(itemType.TypeHandle))
                {
                    ...
                    if (parser is MessageParser messageParser)
                    {
                        _parsers.TryAdd(itemType.TypeHandle, messageParser);
                    }
                    else
                    {
                        return false;
        ...
        public object Deserialize(Type expectedType, IDeserializationContext context)
        {
            ...
            if (!_parsers.TryGetValue(typeHandle, out parser))
            {
